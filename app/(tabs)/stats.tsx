  ...
  return (
    <ScrollView className="flex-1 bg-white dark:bg-gray-950 px-6 pt-16">
      ...
      <View className="flex-row bg-gray-100 dark:bg-gray-800 rounded-xl p-1 mb-6">
        <TouchableOpacity
          className={`flex-1 py-2 rounded-lg items-center ${tab === 'stats' ? 'bg-white dark:bg-gray-700 shadow-sm' : ''}`}
        ...
        <TouchableOpacity
          className={`flex-1 py-2 rounded-lg items-center ${tab === 'leaderboard' ? 'bg-white dark:bg-gray-700 shadow-sm' : ''}`}
          ...
          <>
            ...
            <View className="bg-brand-500 rounded-2xl p-5 mb-4">
              <View className="flex-row items-center justify-between">
                <View>
                  <Text className="text-white/70 text-sm mb-1">{t('stats.bestTime')}</Text>
                  <Text className="text-white text-3xl font-bold font-mono">{stats.bestTime}</Text>
                </View>
